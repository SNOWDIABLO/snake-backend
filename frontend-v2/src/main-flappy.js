/* ===================================================================
   SnowDiablo Arcade — Flappy page entry
   Wires FlappyGame <-> backend (session/end/claim) <-> wallet.
   Passes game='flappy' to /api/session/start for multi-games Phase 4 backend.
   =================================================================== */

import './theme.css';
import './flappy-style.css';
...
async function startGame() {
  ...
  if (isConnected()) {
    try {
      // Phase 4 : multi-games — on passe explicitement game='flappy'
...
// ===================================================================
//  Input — keyboard / mouse / touch : all trigger flap
// ===================================================================
...
document.addEventListener('keydown', (e) => {
  ...
  if (e.key === ' ' || e.key === 'ArrowUp' || e.key === 'w' || e.key === 'W') {
    e.preventDefault();
    if (!game.running && !newGameBtn.disabled) {
      startGame();
    } else {
      game.flap();
    }
